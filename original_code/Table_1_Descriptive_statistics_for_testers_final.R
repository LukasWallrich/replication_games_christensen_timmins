...
testers.path <- "Final Data Sets//tester_assignment.csv"
...
testers.summary = testers.summary[c(1,2,26,27,7,8,9,10,11,12,13,14,17,18,19,20,21,22,23,24,15,16,3,25,4,5,6,28,29),]
